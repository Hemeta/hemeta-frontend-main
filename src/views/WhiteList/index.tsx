...
import HemetaReviewing from './images/hemeta_reviewing_paper.png';
import HemetaHappy from './images/hemeta_happy.png';
import HemetaUpset from './images/hemeta_upset.png';
...
import HemetaModIcon from './images/role_icon_mods.png';
  ...
  return (
    <div className={styles.body}>
      <div className={styles.cover}>
        {isChecking ? (
          <img src={HemetaReviewing} />
        ) : whitelisted ? (
          <img src={HemetaHappy} style={{ width: 240, height: 240 }} />
        ) : (
          <img src={HemetaUpset} />
        )}
      </div>
