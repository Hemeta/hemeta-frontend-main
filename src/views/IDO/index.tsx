...
import happyHemeta from '../IDO/images/hemeta_happy.png';
  ...
  const NotConnectedBox = () => (
    <div className={styles.notConnectedBox}>
      <p className={styles.title}>
        Claim your <span className={styles.highlight}>HEME</span> to join the Hemeta Kingdom now!
      </p>
  ...
  const SuccessBox = () => (
    <>
      <div className={styles.presale_header_success}>
        <h1 className={styles.successTitle}>You’ve claimed your HEME!</h1>
        <h1 className={styles.successSubTitle}>Welcome to the Hemeta’s Kingdom</h1>
      </div>
          ...
          <div className={styles.balance_stats}>
            ...
            <div className={styles.tokenAmounts}>
              <p className={styles.tokenAmount}>
                ...
                <span className={styles.tokenTitle}>HEME</span>
              </p>
            </div>
          </div>
        )}
        {state.purchasedAmount != '0.0' && (
          <div className={styles.contribution}>
            ...
            <div className={styles.tokenAmounts}>
              ...
              <p className={styles.tokenSubTitle}>5 MAI = 1 HEME</p>
            </div>
          </div>
        )}
        {state.purchasedAmount != '0.0' && (
  ...
  return (
    <div className={styles.body}>
      ...
      <div className={styles.hero_section}>
        <h1 className={styles.title}>Claim your HEME</h1>
        <p className={styles.desc}>
          The IDO will be held from Nov 1, 2021 0:00 UTC to Nov 2, 2021 23:59 UTC. Join the Hemeta`s Kingdom now!🦦
        </p>
      </div>

      <div className={styles.mainBox}>
        <div className={styles.happyHemetaBox}>
          <img src={happyHemeta} className={styles.happyHemeta} />
        </div>
      ...
      <div className={styles.claimHemeBox}>
        {connected ? (
